...
if apiVersion >= 1.40 then
    ...
    if apiVersion >= 1.44 then
        ...
        fields[#fields + 1] = {
            ...
            max = 3,
            vals = { 51 },
            table = { [0] = "OFF", "2_POINT", "3_POINT", "4_POINT" },
        }
        fields[#fields + 1] = {
            t = "Boost",
            x = x + indent,
...
if apiVersion >= 1.41 then
    ...
    fields[#fields + 1] =
        { t = "Gain", x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 100, vals = { 43 } }
    fields[#fields + 1] =
        { t = "Advance", x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 200, vals = { 44 } }
end
