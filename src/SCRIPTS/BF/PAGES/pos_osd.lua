...
return {
    ...
    postLoad = function(self)
        ...
        self.fields[2].value, self.fields[3].value, self.fields[4].value, self.fields[5].value =
            self.splitVal(self, self.values[firstVal], self.values[secondVal])
    end,
    preSave = function(self)
        self.values = {}
        self.values[1] = self.fields[1].value
        local combineValue = self.checkProfile(
            self,
            self.fields[2].value,
            self.fields[3].value,
            self.fields[4].value,
